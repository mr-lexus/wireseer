...
impl Theme {
    ...
    pub const fn named(name: ThemeName) -> Self {
        match name {
            ThemeName::WireseerDark => Self {
                background: Color::Rgb(7, 10, 15),
                surface: Color::Rgb(12, 18, 25),
                surface_active: Color::Rgb(18, 30, 39),
                border: Color::Rgb(40, 58, 70),
                border_focused: Color::Rgb(59, 230, 255),
                text_primary: Color::Rgb(221, 238, 244),
                text_secondary: Color::Rgb(132, 160, 174),
                text_muted: Color::Rgb(68, 88, 101),
                accent: Color::Rgb(59, 230, 255),
                success: Color::Rgb(94, 234, 170),
                warning: Color::Rgb(245, 190, 75),
                danger: Color::Rgb(255, 91, 121),
                info: Color::Rgb(133, 130, 255),
                selection: Color::Rgb(20, 68, 78),
                selection_text: Color::Rgb(239, 253, 255),
                chart_primary: Color::Rgb(59, 230, 255),
                chart_secondary: Color::Rgb(133, 130, 255),
            },

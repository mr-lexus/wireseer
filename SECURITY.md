...
Lantern is for networks the operator owns or is explicitly authorized to inspect. It provides
inventory and change awareness, not exploitation or vulnerability assessment.

Lantern intentionally excludes credential attacks, authentication attempts, brute force, path
...
contact configured for the repository. Include the Lantern version, operating system, reproduction,
